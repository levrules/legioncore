    ...
    public:
        ...
        void loadConfig()
        {
            ...
            diff_Multiplier =
            {
                ...
                {755, sConfigMgr->GetFloatDefault("Solocraft.LostCityOfTheTolvir", 5.0) }, // Затерянный город Тол'вир
            ...
            diff_Multiplier_Heroics =
            {
                ...
                {755, sConfigMgr->GetFloatDefault("Solocraft.LostCityOfTheTolvirH", 5.0) },
                ...
                {859, sConfigMgr->GetFloatDefault("Solocraft.ZulgurubH", 5.0) },
